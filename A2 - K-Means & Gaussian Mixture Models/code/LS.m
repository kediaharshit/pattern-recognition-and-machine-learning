...
view (az, el);
hold off;
saveas(gca,sprintf('LS_gaussians.jpg'));
...
legend(h(1:3), {'class 1', 'class 2', 'class 3'}, 'Location', 'southeast');
hold off;
saveas(figure1,sprintf('LS_case_2.jpg'));
...
legend(h(1:3), {'class 1', 'class 2', 'class 3'}, 'Location', 'southeast');
hold off;
saveas(figure1,sprintf('LS_case_3.jpg'));
...
legend(h(1:3), {'class 1', 'class 2', 'class 3'}, 'Location', 'southeast');
hold off;
saveas(figure1,sprintf('LS_case_4.jpg'));
...
legend(h(1:3), {'class 1', 'class 2', 'class 3'}, 'Location', 'southeast');
hold off;
saveas(figure1,sprintf('LS_case_5.jpg'));