...
hold(axes1,'all');
plot(ROC(1,:,1), ROC(1,:,2), ROC(2,:,1), ROC(2,:,2), ROC(3,:,1), ROC(3,:,2), ROC(4,:,1), ROC(4,:,2), ROC(5,:,1), ROC(5,:,2), 'LineWidth', 4);
title(sprintf('ROC Curve'));
xlabel('False Positive Rate');
ylabel('True Positive Rate');
legend({'Case 1', 'Case 2', 'Case 3', 'Case 4', 'Case 5'}, 'Location', 'southeast');
saveas(figure1, sprintf('LS_ROC.jpg'));

figure2 = figure;
axes1 = axes('Parent',figure2);
hold(axes1,'all');
plot(DET(1,:,1), DET(1,:,2), DET(2,:,1), DET(2,:,2), DET(3,:,1), DET(3,:,2), DET(4,:,1), DET(4,:,2), DET(5,:,1), DET(5,:,2), 'LineWidth', 4);
title(sprintf('DET Curve'));
xlabel('False Alarm Rate');
ylabel('Missed Detection Rate');
legend({'Case 1', 'Case 2', 'Case 3', 'Case 4', 'Case 5'}, 'Location', 'northeast');
saveas(figure2, sprintf('LS_DET.jpg'));